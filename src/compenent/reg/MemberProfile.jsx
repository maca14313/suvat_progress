...
<div className='regCon'>
    ...
    <div  className='formCon' >
       <div className='row listCon idColor'><span>Id</span> <span>{regInfo.id}</span></div>    
          <div className='row listCon'><span>Name</span> <span>{regInfo.name}</span></div>
          <div className='row listCon'><span>Father_name</span> <span>{regInfo.father_name}</span></div>
          <div className='row listCon'><span>Grand_father_name</span> <span>{regInfo.grand_father_name}</span></div>
